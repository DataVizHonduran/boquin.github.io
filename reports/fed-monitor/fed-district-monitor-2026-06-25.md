# 🏛️ Federal Reserve District Monitor — 2026-06-25
...
Based on the recent publications from the Federal Reserve districts, here are the most analytically significant pieces for our investment strategy:

1. **[NY] The Post-COVID Decline in the Labor Share**: This research highlights that the labor share of income has hit its lowest level since the post-war era. This structural shift suggests a long-term redistribution of income toward capital, which may dampen aggregate consumer spending power and alter the long-term neutral rate ($r^*$).

2. **[NY] Synthetic Stablecoins and Financial Stability**: The paper analyzes a 2025 tariff shock that triggered simultaneous risk-off moves in Treasuries and digital assets. This underscores the increasing contagion risk between "synthetic" digital assets and traditional credit markets, suggesting that geopolitical trade volatility now has a direct transmission mechanism into systemic financial stability.

3. **[NY] The New York Fed DSGE Model Forecast—June 2026**: This provides the latest baseline projections for growth and inflation from one of the Fed's primary modeling frameworks. These forecasts are critical for our positioning as they likely signal the Fed's internal expectations for the terminal rate and the timing of any policy pivots for the remainder of 2026.

4. **[RIC] Forecasting Wage Growth Using Months Supply**: The Richmond Fed proposes a new "months supply" metric to better gauge labor market tightness and predict wage growth. For our team, this means we should pivot toward this metric to better anticipate wage-push inflation, which will be the primary driver of the Fed's "higher for longer" or "pivot" decision.

**Synthesis:** The macro outlook is currently defined by a structural erosion of labor income and heightened sensitivity to geopolitical trade shocks. Consequently, the Fed is refining its forecasting tools to better manage wage-push inflation within an increasingly volatile and unstable financial ecosystem.

---

## New York Fed (2nd District)
**Content Type:** Liberty Street Economics Blog | **New:** 1 of 3
