# 🏛️ Federal Reserve District Monitor — 2026-07-02
...
I have reviewed the latest research output from the Federal Reserve districts. While the recent window contains significant noise and empty placeholders, there are three critical pieces of analysis that impact our current positioning in equities and fixed income.

1. **[NY] The Disappearing Overnight Drift**: This research indicates a breakdown in the historical "overnight drift" (the persistent return of equity futures between 2:00 and 3:00 a.m. ET). For our quantitative strategies, this suggests that previous timing models based on overnight alpha are decaying, necessitating a shift toward more dynamic, intraday volatility plays.

2. **[NY] Liquidity Fades as Treasuries Age**: The Fed highlights a stark liquidity divide where "on-the-run" securities dominate trading volume despite representing less than 4% of outstanding debt. This implies a significant "liquidity cliff" for off-the-run Treasuries, increasing the risk of price gapping and volatility during periods of systemic stress or rapid rate adjustments.

3. **[RIC] How Much Does the US Economy Rely on Fossil Fuels?**: This analysis argues that aggregate fossil fuel use in gross output has remained stubbornly constant despite the energy transition. This suggests that "green" GDP growth is currently additive rather than substitutive, meaning energy price shocks will continue to have a more potent inflationary impact on the macro economy than current transition narratives suggest.

**Synthesis:** The data points toward a regime of diminishing predictability in equity timing and heightened fragility in the Treasury market's plumbing. Simultaneously, the persistence of fossil fuel reliance suggests that the "inflation floor" remains higher than the market is currently pricing into long-term bonds.

---

## New York Fed (2nd District)
**Content Type:** Liberty Street Economics Blog | **New:** 1 of 2
...
### (cached) [Liquidity Fades as Treasuries Age](https://libertystreeteconomics.newyorkfed.org/2026/06/liquidity-fades-as-treasuries-age/)
**Published:** 2026-06-30 | **Authors:** Alain Chaboud, Ellen Correia Golay, Michael J. Fleming, Yesol Huh, Frank M. Keane, and Or Shachar
...
**Tags:** interest rates · financial stability · banking · credit · financial regulation · monetary policy
...
### (cached) [](https://www.dallasfed.org/research/economics/2026/0625)
**Published:**  | **Authors:** 
...
### (cached) [](https://www.dallasfed.org/research/economics/2026/0623)
**Published:**  | **Authors:** 
