# 🏛️ Federal Reserve District Monitor — 2026-06-28
...
Based on the provided list, there is only one substantive publication available for analysis; the remaining entries are either empty placeholders or directory headers for other districts. As a senior economist, I cannot synthesize data that is not present, but I have analyzed the single available piece of research below.

1. **[NY] How Resilient Were Emerging Market Economies Through the 2022‑23 U.S. Monetary Tightening Cycle?**
   This research examines the cross-border spillover effects of U.S. monetary policy, specifically assessing whether EM economies have developed better structural buffers to withstand aggressive Fed tightening. For our team, this is critical for determining if EM sovereign debt and currency assets are fundamentally more resilient than in previous cycles or if we are underestimating systemic fragility.

*(Note: Entries 2–23 provided no titles or abstracts and consisted primarily of directory listings for the St. Louis Fed's aggregation of other districts' publications.)*

**Synthesis:**
The available research indicates a focus on the evolving relationship between U.S. monetary policy and global financial stability, specifically regarding Emerging Market resilience. We should use these findings to calibrate our EM risk premiums and assess whether the "spillover" risk from the Fed has
