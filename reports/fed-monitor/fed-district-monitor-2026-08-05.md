# 🏛️ Federal Reserve District Monitor — 2026-08-05
...
After reviewing the recent publications across the Federal Reserve districts, the available data set is significantly constrained. Most entries are placeholders or aggregate indices. However, the following analysis focuses on the only substantive analytical contribution provided in this window.

1. **[NY] A Window into Bond Investors’ Uncertainty About R-Star**
This paper examines how the term structure of sovereign bond yields reflects market uncertainty regarding the "natural rate of interest" (r-star). For our desk, this is critical because if the market is mispricing the long-term equilibrium rate, we face significant duration risk in our fixed-income portfolios. Understanding the Fed's view on r-star uncertainty helps us anticipate whether the FOMC will be more reactive to short-term data or anchored to a long-term theoretical neutral rate.

*(Note: Due to the lack of substantive content in publications 2–23, no further individual analyses can be performed. The remaining entries provided were empty headers or directory listings.)*

**Synthesis:**
The current research window is dominated by a singular focus on the instability of r-star expectations and the resulting volatility in sovereign bond yields. We should maintain a cautious posture on long-dated Treasuries until there is more clarity on whether the Fed believes the neutral rate has shifted structurally.

---

## New York Fed (2nd District)
**Content Type:** Liberty Street Economics Blog | **New:** 1 of 1

### 🆕 [A Window into Bond Investors’ Uncertainty About R‑Star](https://libertystreeteconomics.newyorkfed.org/2026/08/a-window-into-bond-investors-uncertainty-about-r-star/)
**Published:** 2026-08-04 | **Authors:** 

The paper examines how sovereign bond yields reflect market participants' beliefs and uncertainty regarding the natural real rate of return (r-star). It analyzes the term structure of yields to determine the extent to which investors can accurately signal the neutral rate to policymakers.
...
**Content Type:** Economics Publications | **New:** 1 of 3

### 🆕 [](https://www.dallasfed.org/research/economics/2026/0804)
**Published:**  | **Authors:** 
