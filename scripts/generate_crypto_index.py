"""
Generate index.html for Crypto CTA Signals with bar chart landing page and mode selector
"""
...
if not os.path.exists(summary_path):
    print(f"Error: {summary_path} not found. Run generate_crypto_cta_signals.py first.")
    exit(1)
...
def create_position_bar_chart(positions, mode):
    ...
    fig.update_layout(
        title=dict(
            text=f"Crypto CTA {mode.upper()} Mode - Current Positioning",
            x=0.5,
            xanchor='center',
...
# Get recent signals
fast_signals = all_summaries['fast'].get('recent_signals_30d', {})
slow_signals = all_summaries['slow'].get('recent_signals_30d', {})
...
<head>
    ...
    <title>Crypto CTA Exhaustion Signals</title>
...
<body>
    <div class="container">
        <h1>🪙 Crypto CTA Exhaustion Signals</h1>

        <div class="info-box">
            <div class="stats-grid">
                <div class="stat-item">
                    <div class="stat-label">Cryptos Tracked</div>
                    <div class="stat-value">{all_summaries['fast']['cryptocurrencies']}</div>
                </div>
                <div class="stat-item">
        ...
        <div class="methodology">
            ...
            <p><strong>Fast Mode:</strong> Uses 20/50/100 day EMAs for more responsive signals - better for short-term crypto volatility.</p>
            <p><strong>Slow Mode:</strong> Uses 50/100/200 day EMAs for longer-term trends - better for position trading.</p>
            ...
            <p><strong>Data Source:</strong> CoinGecko API - updated daily.</p>
        </div>
        ...
        <div class="currency-list">
            <h3>View Individual Cryptocurrency Charts</h3>
...
print(f"✅ Generated index.html with bar charts for {len(fast_positions)} cryptocurrencies")
...
print(f"   - URL: https://boquin.xyz/reports/crypto-cta-signals/")
